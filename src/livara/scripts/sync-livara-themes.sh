...
:root {
  ...
  --livara-on-primary: $(json_color on_primary);
...
EOF
    ...
    sync_gtk_theme() {
      ...
      write_atomic "$XDG_CONFIG_HOME/gtk-3.0/gtk.css" <<EOF
/* Generated by Livara from palette.$PALETTE_VARIANT.json. */
@define-color theme_bg_color $(json_color base);
@define-color theme_base_color $(json_color surface0);
@define-color theme_fg_color $(json_color text);
@define-color theme_text_color $(json_color text);
@define-color selected_bg_color $(json_color primary);
@define-color selected_fg_color $(json_color on_primary);
@define-color insensitive_bg_color $(json_color surface1);
@define-color insensitive_fg_color $(json_color subtext0);
@define-color borders $(json_color overlay0);
EOF
      write_atomic "$XDG_CONFIG_HOME/gtk-4.0/gtk.css" <<EOF
/* Generated by Livara from palette.$PALETTE_VARIANT.json. */
@define-color window_bg_color $(json_color base);
@define-color window_fg_color $(json_color text);
@define-color view_bg_color $(json_color base);
@define-color view_fg_color $(json_color text);
@define-color headerbar_bg_color $(json_color surface0);
@define-color headerbar_fg_color $(json_color text);
@define-color sidebar_bg_color $(json_color surface0);
@define-color sidebar_fg_color $(json_color text);
@define-color card_bg_color $(json_color surface0);
@define-color card_fg_color $(json_color text);
@define-color popover_bg_color $(json_color surface0);
@define-color popover_fg_color $(json_color text);
@define-color dialog_bg_color $(json_color surface0);
@define-color dialog_fg_color $(json_color text);
@define-color accent_color $(json_color primary);
@define-color accent_bg_color $(json_color primary);
@define-color accent_fg_color $(json_color on_primary);
@define-color destructive_color $(json_color error);
@define-color destructive_bg_color $(json_color error);
@define-color destructive_fg_color $(json_color on_error);
@define-color success_color $(json_color green);
@define-color warning_color $(json_color yellow);
@define-color error_color $(json_color error);
EOF
